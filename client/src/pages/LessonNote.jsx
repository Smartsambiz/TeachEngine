                    ...
                    <Card as="form" onSubmit={handleSubmit} className="space-y-5 p-5 sm:p-6">
                        ...
                        {structuredLesson ? (
                            <article className="space-y-8 text-sm leading-7 text-slate-600">
                                ...
                                {structuredLesson.introduction && <section><h2 className="section-title">Introduction</h2><p className="mt-3"><strong>Teacher activity:</strong> {structuredLesson.introduction.teacherActivity}</p><MermaidViewer chartCode={structuredLesson.introduction?.suggestedVisual}/>{structuredLesson.introduction?.illustrationUrl && (<img src={structuredLesson.introduction.illustrationUrl} className="w-full max-w-xl mx-auto my-4 rounded-xl border border-slate-200 shadow-sm object-cover"/>)}<p className="mt-2"><strong>Student activity:</strong> {structuredLesson.introduction.studentActivity}</p><p className="mt-2"><strong>Expected responses:</strong> {structuredLesson.introduction.expectedResponses?.join(" ")}</p></section>}
